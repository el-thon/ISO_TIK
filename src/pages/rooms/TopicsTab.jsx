              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3 mt-4">
                    <span className="text-xs px-2 py-1 rounded-full bg-amber-100 text-amber-700">Changes Requested</span>
                ...
                <div className="flex flex-col items-end gap-4">
                  ...
                  <div className="text-sm text-muted-foreground"><svg xmlns="http://www.w3.org/2000/svg" className="inline-block w-4 h-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg> {t.due}</div>
                </div>
              </div>
            </CardContent>
          </Card>
